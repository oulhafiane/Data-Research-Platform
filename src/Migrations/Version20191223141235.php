 ...
 */
final class Version20191223141235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE data_set (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, privacy SMALLINT NOT NULL, creation_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_A298C469D17F50A6 (uuid), INDEX IDX_A298C4697E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE table_t (id INT AUTO_INCREMENT NOT NULL, data_set_id INT NOT NULL, title VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F0B6665A70053C01 (data_set_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE part (id INT AUTO_INCREMENT NOT NULL, data_set_id INT NOT NULL, title VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_490F70C670053C01 (data_set_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE variable (id INT AUTO_INCREMENT NOT NULL, part_id INT DEFAULT NULL, table_t_id INT NOT NULL, name VARCHAR(100) NOT NULL, question VARCHAR(255) DEFAULT NULL, type SMALLINT NOT NULL, options LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_CC4D878D4CE34BEC (part_id), INDEX IDX_CC4D878D16CFB43E (table_t_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE table_t ADD CONSTRAINT FK_F0B6665A70053C01 FOREIGN KEY (data_set_id) REFERENCES data_set (id)');
        ...
        $this->addSql('ALTER TABLE part ADD CONSTRAINT FK_490F70C670053C01 FOREIGN KEY (data_set_id) REFERENCES data_set (id)');
        $this->addSql('ALTER TABLE variable ADD CONSTRAINT FK_CC4D878D4CE34BEC FOREIGN KEY (part_id) REFERENCES part (id)');
        $this->addSql('ALTER TABLE variable ADD CONSTRAINT FK_CC4D878D16CFB43E FOREIGN KEY (table_t_id) REFERENCES table_t (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE table_t DROP FOREIGN KEY FK_F0B6665A70053C01');
        $this->addSql('ALTER TABLE part DROP FOREIGN KEY FK_490F70C670053C01');
        ...
        $this->addSql('ALTER TABLE variable DROP FOREIGN KEY FK_CC4D878D16CFB43E');
        ...
        $this->addSql('ALTER TABLE variable DROP FOREIGN KEY FK_CC4D878D4CE34BEC');
        ...
        $this->addSql('DROP TABLE table_t');
